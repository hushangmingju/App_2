...
$data = '{"actions":[{"user_action_set_id":"1109635863","url":"http://www.mingjugroup.com/bd/yd/index.php","action_time":1513077790,"action_type":"COMPLETE_ORDER","trace":{"click_id":"' . $_POST['clickID'] . '"},"action_param":{"value":40}}]}';
$actions = array();
$actions['user_action_set_id'] = 1109635863;
$actions['url'] = 'http://www.mingjugroup.com/bd/yd/index.php';
