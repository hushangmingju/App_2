...
<html>
	...
	<body>
		...
		<div class="content">
			       ...
			       <div class="mainc">
			              <div class="jg6tit p-tb-10"><img src="images/title_01.png"></div>
							...
							<div id="con_jobc_1"  <?php if($jid==1){echo "class='hover'";}else{echo "style='display:none'";} ?> >
									...
									<div class="jgncon">
										<div class="jgs1"><img src="images/jg6.jpg"></div>
										<div class="jgs2">
											<div class="wz1 ys1">01.实景样板间，所见即所得</div>
											<div class="wz2">
											  沪尚茗居首创十几款不同风格、不同价位的实景样板间，从中式到西式，从简约到奢华，满足了不同人群的不同需求。完美实现1:1实景复制，实景样板间什么样，明天您家就是什么样。
											</div>
										</div>
										<div class="clear"></div>
									</div>
							...
							<div id="con_jobc_2"   <?php if($jid==2){echo "class='hover'";}else{echo "style='display:none'";} ?> >
									...
									<div class="jgncon">
										<div class="jgs1"><img src="images/jg6.jpg"></div>
										<div class="jgs2">
											<div class="wz1 ys2">02.工厂价装修，价格超低</div>
											<div class="wz2">
							...
							<div id="con_jobc_5"   <?php if($jid==5){echo "class='hover'";}else{echo "style='display:none'";} ?> >
									...
									<div class="jgncon">
										<div class="jgs1"><img src="images/jg6.jpg"></div>
										<div class="jgs2">
											<div class="wz1 ys5">05.规范施工，全程质保</div>
											<div class="wz2">
							...
							<div id="con_jobc_6"   <?php if($jid==6){echo "class='hover'";}else{echo "style='display:none'";} ?> >
									...
									<div class="jgncon">
										...
										<div class="jgs2">
											...
											<div class="wz2">
											  选材料是装修的关键一步，材料选的好，装修工程才能算是完美。沪尚茗居通过整合供应链，与百余家知名牌厂家直接建立合作，精选满足国家环保要求的产品。合理的价格，环保的产品，让您与您的家人享受最安全健康的居住环境。辅材有美国联想接线端子、德国的欧松板、环保无碳的石膏板、水电行业领军品牌伟星管线、多乐士安心家乳胶漆等知名品牌产品。
											</div>
										</div>
										<div class="clear"></div>
									</div>
							...
							<div id="con_jobc_7"    <?php if($jid==7){echo "class='hover'";}else{echo "style='display:none'";} ?>  >
									...
									<div class="jgncon">
										<div class="jgs1"><img src="images/jg6.jpg"></div>
										<div class="jgs2">
											<div class="wz1 ys7">07.自由选择，您温暖的家</div>
											<div class="wz2">
