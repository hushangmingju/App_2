...
?> 
  ...
  ?>
    <section style="margin:0px; padding:0px; text-align:center; width:100%;">
      <div style="width:90%; display:inline-block; margin:<?php echo $i == 0 ? '0px' : '10px';?> 0px 10px 0px; padding:0px; max-width:<?php echo $maxWidth;?>;">
  <?php
          if (isset($pictures[$i]['head']) && $pictures[$i]['head']) {
  ?>
        <h4><?php echo $pictures[$i]['head'];?></h4>
  <?php
          }
  ?>
  ...
  <?php
          if (isset($pictures[$i]['content']) && $pictures[$i]['content']) {
  ?>
        <p style="text-align:left; text-indent:2em;"><?php echo $pictures[$i]['content'];?></p>
  <?php
          }
  ?>         
      </div>
